...
# // Banner
echo -e "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e "${BIBlue}│ ${BGCOLOR}  WELCOME TO AUTOSCRIPT PREMIUM         ${BIBlue} │${NC}"
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
echo ""
sleep 4
clear
...
data_ip="https://raw.githubusercontent.com/huutvpn/barak/main/ip"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    echo -e ""
    echo -e "            \033[91;1mbarak DENIED !\033[0m"
    echo -e "   \033[0;33mYour VPS\033[0m $ipsaya \033[0;33mHas been Banned\033[0m"
    echo -e "     \033[0;33mBuy access baraks for scripts\033[0m"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/huutvpn/ismailtheart/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/huutvpn/barak/main/ip"
# USERNAME
rm -f /usr/bin/user
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"http://wa.me/+62823877826797"}]]}' 
...
wget -q https://raw.githubusercontent.com/huutvpn/ismailtheart/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
function noobzvpn(){
clear
wget --no-check-certificate https://raw.githubusercontent.com/huutvpn/ismailtheart/main/noobzvpns.zip
unzip noobzvpns.zip
cd noobzvpns
bash install.sh
...
cd
    ...
    wget https://raw.githubusercontent.com/huutvpn/ismailtheart/main/menu/menu.zip
    unzip menu.zip
    chmod +x menu/*
