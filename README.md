...
## UPDATE
```
wget https://raw.githubusercontent.com/huutvpn/ismailtheart/main/update.sh && chmod +x update.sh && ./update.sh
```
...
# pilih salah satu repo utk mempercepat proses ismailtheart 
#id 1
```
